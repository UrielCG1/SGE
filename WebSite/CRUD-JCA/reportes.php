...
<div class="container mt-4">
    <h1 class="text-center">Panel de Administrador | Reportes</h1>
    <div class="text-right mb-3">
        <a href="registrarSala.php" class="btn btn-primary">Crear Sala</a>
        <button class="btn btn-secondary" onclick="mostrarReporte('disponibilidad')">Reporte de Disponibilidad</button>
        <button class="btn btn-secondary" onclick="mostrarReporte('ubicacion')">Reporte de Ubicación</button>
        <button class="btn btn-secondary" onclick="mostrarReporte('capacidad')">Reporte de Capacidad</button>
    </div>
...
<script>
    ...
    function mostrarReporte(tipoReporte) {
        switch(tipoReporte) {
            case 'disponibilidad':
                window.location.href = 'reporteDisponibilidad.php';
                break;
            case 'ubicacion':
                window.location.href = 'reporteUbicacion.php';
                break;
            case 'capacidad':
                window.location.href = 'reporteCapacidad.php';
                break;
            default:
                console.error('Tipo de reporte desconocido:', tipoReporte);
        }
    }
</script>
</body>
