...
<div class="container mt-4">
    <h1 class="text-center">Reporte de Ubicación</h1>
    <table id="tablaUbicacion" class="table table-striped table-bordered" style="width:100%">
...
<script>
    $(document).ready(function () {
        $('#tablaUbicacion').DataTable({
            ajax: {
                url: "daoCargarDatosUbicacion.php",
                dataSrc: 'data'
            },
            columns: [
                { data: "ID Sala" },
