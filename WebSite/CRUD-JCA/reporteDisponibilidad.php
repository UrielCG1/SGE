...
<div class="container mt-4">
    <h1 class="text-center">Reporte de Disponibilidad</h1>
    <table id="tablaDisponibilidad" class="table table-striped table-bordered" style="width:100%">
...
<script>
    $(document).ready(function () {
        $('#tablaDisponibilidad').DataTable({
            ajax: {
                url: "daoCargarDatosDisponibilidad.php",
                dataSrc: 'data'
            },
            columns: [
                { data: "ID Sala" },
